...
-- 58. Liệt kê tên các dự án bắt đầu trong năm 2023.
	SELECT TenDuAn
	FROM DuAn
	WHERE NgayBatDau BETWEEN '2023-01-01' AND '2023-12-31';
...
-- 62. Liệt kê tên các dự án có ngày kết thúc trong năm 2023.
	SELECT TenDuAn
	FROM DuAn
	WHERE NgayKetThuc BETWEEN '2023-01-01' AND '2023-12-31';
...
-- 64. Liệt kê mã chuyên gia và vai trò trong các dự án từ bảng ChuyenGia_DuAn.
	SELECT ChuyenGia.MaChuyenGia, ChuyenGia_DuAn.VaiTro
	FROM ChuyenGia_DuAn
